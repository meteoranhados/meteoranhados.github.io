(() => {
  ...
  async function setupSiteFooter(){
    ...
    const version=document.createElement('span');version.className='ranhados-external-footer__version';version.textContent='Meteo Ranhados v3.0.4 · 15/09/2026';
  ...
  function setupServiceWorker(){
    ...
    navigator.serviceWorker.register('/sw.js?v=3.0.4',{scope:'/'}).then(reg=>{reg.update().catch(()=>{});
