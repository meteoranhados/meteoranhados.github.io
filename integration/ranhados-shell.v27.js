(() => {
  ...
  async function setupSiteFooter(){
    ...
    const version=document.createElement('span');version.className='ranhados-external-footer__version';version.textContent='Meteo Ranhados v3.0.1 · 13/09/2026';
  ...
  function setupServiceWorker(){
    ...
    navigator.serviceWorker.register('/sw.js?v=3.0.1',{scope:'/'}).then(reg=>{reg.update().catch(()=>{});
