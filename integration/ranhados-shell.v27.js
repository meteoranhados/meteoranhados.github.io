(() => {
  ...
  async function setupSiteFooter(){
    ...
    const version=document.createElement('span');version.className='ranhados-external-footer__version';version.textContent='Meteo Ranhados v4.0.0-alpha3 · 26/09/2026';
  ...
  function setupServiceWorker(){
    ...
    navigator.serviceWorker.register('/sw.js?v=4.0.0-alpha3',{scope:'/'}).then(reg=>{reg.update().catch(()=>{});
